...
SERIES = [
    ...
    {"n": 5, "slug": "okane-05-nanyo-chihokyoku", "c": "#846f42",
     "title": "南予地方局とは何なのか",
     "lead": "県の出先機関が大洲にある。何を決め、何をしているのか。市役所とどう違うのか。",
     "done": False},
    ...
    {"n": 8, "slug": "okane-08-doko-ni-tsukau", "c": "#7b5060",
     ...
     "lead": "経常収支比率99.7％。残った1億4,778万7千円と、臨時のお金で何を建て、何に使ったか。",
     "done": False},
    {"n": 9, "slug": "okane-09-dare-ga-yaru", "c": "#3a6a64",
     "title": "市がやっていない仕事は、誰がやるのか",
     "lead": "消防もごみも、大洲市だけではやっていない。一部事務組合、指定管理、外部委託。",
     "done": False},
...
# 第8回の芯(2026-09-13、本人の指示)
#   「経常収支比率で、大洲はほぼ100%だったけど、自由に使えるお金で何をしたのか知りたい。」
#   決算カードに 経常一般財源等 16,047,572千円 / 経常経費充当一般財源等 15,899,785千円 があり、
#   差は 147,787千円(1億4,778万7千円)。これに臨時のお金を足したぶんが「自由に使えた分」。
#   投資的経費 4,976,122千円 のうち 充当一般財源等 1,012,326千円 が市の自前。
#   何を建て、何に使ったかまで会議録で追えるはず。施設名で見せる回なので、ここを主役にする。
#
